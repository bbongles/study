 ...
 * 자바 프로그래밍
 * - 자바의 역사
 *   - 1991년 제임스 고슬링을 비롯한 선 마이크로 시스템즈 연구원들이 처음 개발.
 *   - 가전, 휴대용 장치에 사용되는 소프트웨어 언어로 개발됌.
 *   - 안정성이 중요
 * ---------------------------------------------------------------------------------------------------
 * - 자바 프로그래밍의 특징
 ...
 *  - OOP(Object Oriented Programming)이라고 함 (cf. 절차 지향 프로그래밍)
 *  - 사용하는 언어 : Java, C++, C#, Python, JavaScript, Ruby 등 다수
 * ---------------------------------------------------------------------------------------------------
 * 자바 프로그래밍(객체 지향 프로그래밍)의 장점
 *  - 재사용성
 *  - 유지보수
 *  - 코드 관리
 *  - 신뢰성 높은 프로그램
 ...
 * ---------------------------------------------------------------------------------------------------
 * 용어 정리
 * - JDK(Java Deveplopment Kit) : 자바에서 제공되는 개발용 라이브러리. 계속 버전이 올라가고 있음
